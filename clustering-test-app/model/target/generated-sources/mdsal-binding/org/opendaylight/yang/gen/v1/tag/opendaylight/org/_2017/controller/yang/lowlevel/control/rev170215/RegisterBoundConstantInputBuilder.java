...
/**
 * Class that builds {@link RegisterBoundConstantInputBuilder} instances.
 * 
...
public class RegisterBoundConstantInputBuilder implements Builder<RegisterBoundConstantInput> {
    ...
    Map<Class<? extends Augmentation<RegisterBoundConstantInput>>, Augmentation<RegisterBoundConstantInput>> augmentation = Collections.emptyMap();
    ...
    public RegisterBoundConstantInputBuilder(RegisterBoundConstantInput base) {
        ...
        if (base instanceof RegisterBoundConstantInputImpl) {
            ...
            Map<Class<? extends Augmentation<RegisterBoundConstantInput>>, Augmentation<RegisterBoundConstantInput>> aug =((AugmentationHolder<RegisterBoundConstantInput>) base).augmentations();
            if (!aug.isEmpty()) {
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<RegisterBoundConstantInput>> E augmentation(Class<E> augmentationType) {
        return (E) augmentation.get(CodeHelpers.nonNullValue(augmentationType, "augmentationType"));
    }

    
    public RegisterBoundConstantInputBuilder setConstant(final String value) {
    ...
    public RegisterBoundConstantInputBuilder addAugmentation(Class<? extends Augmentation<RegisterBoundConstantInput>> augmentationType, Augmentation<RegisterBoundConstantInput> augmentationValue) {
    ...
    public RegisterBoundConstantInputBuilder removeAugmentation(Class<? extends Augmentation<RegisterBoundConstantInput>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class RegisterBoundConstantInputImpl implements RegisterBoundConstantInput {
        ...
        private Map<Class<? extends Augmentation<RegisterBoundConstantInput>>, Augmentation<RegisterBoundConstantInput>> augmentation = Collections.emptyMap();
    
        RegisterBoundConstantInputImpl(RegisterBoundConstantInputBuilder base) {
            this._constant = base.getConstant();
            this._context = base.getContext();
        ...
        public boolean equals(Object obj) {
            ...
            if (!RegisterBoundConstantInput.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            RegisterBoundConstantInput other = (RegisterBoundConstantInput)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<RegisterBoundConstantInput>>, Augmentation<RegisterBoundConstantInput>> e : augmentation.entrySet()) {
